                    ...
                    <TD vAlign="top" className="min-w-[240px]">
                      <div className="flex items-start gap-3">
                        <div className="flex-shrink-0">
                          ...
                          />
                          <div
                            className="w-14 h-14 rounded-xl flex-shrink-0 items-center justify-center bg-gradient-to-br from-violet-400 to-violet-600 text-white font-bold text-lg shadow-sm"
                            style={{ display: "none" }}
                          >
