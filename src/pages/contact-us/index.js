...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br max-w-[2000px] 2xl:w-[80%] mx-auto from-gray-50 via-white to-orange-50">
      {/* Main Content */}
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              {/* Email */}
              <div className="flex items-start gap-4 p-5 bg-white rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition-shadow">
          ...
          <div className="bg-white rounded-2xl shadow-xl p-8 lg:p-10 border border-gray-100">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white font-semibold py-3.5 px-6 rounded-lg hover:from-orange-600 hover:to-orange-700 focus:outline-none focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 transition-all shadow-md hover:shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {isSubmitting ? (
