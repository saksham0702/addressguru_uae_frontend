...
const CustomButton = ({
  ...
  return (
    <button
      ...
      className="whitespace-nowrap max-[375px]:!w-28 hover:drop-shadow-lg shadow-white transition-all duration-300 hover:cursor-pointer max-[375px]:!h-7 max-[375px]:!text-[9px]"
      style={{
