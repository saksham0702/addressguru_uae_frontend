  ...
  return (
    <>
      ...
      <button
        ...
        className="absolute right-4 flex-shrink-0 flex items-center justify-center p-2 bg-white border border-gray-200 rounded-full hover:bg-gray-50 transition-colors "
        aria-label="Toggle Filters"
      >
        {/* Filter icon SVG — slightly smaller */}
        <svg
          width="16"
          height="14"
          viewBox="0 0 23 21"
        ...
        {activeCount > 0 && (
          <span className="absolute -top-1 -right-1 w-3.5 h-3.5 bg-orange-500 text-white text-[9px] font-bold rounded-full flex items-center justify-center border-white border">
            {activeCount}
          </span>
        )}
      </button>
