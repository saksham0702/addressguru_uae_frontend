      ...
      <div className="max-md:max-w-full md:p-3 p-2 rounded-lg md:my-1 my-0.5 hidden md:block  md:border-none ">
        <div className="md:w-[98%] max-md:p-[1px] ">
          <div className=" py-1.5 relative flex max-md:gap-2 md:gap-4 gap-3  max-[340px]:!gap-2 ">
            ...
            <Link
              href={`/${data?.slug}`}
              className="md:w-[160px] md:max-h-[195px] max-md:max-w-[34%] max-md:h-[130px] border-1 border-gray-200 rounded-sm max-[340]:w-[140px]  2xl:w-[190px] 2xl:h-[220px]  overflow-hidden "
            >
              <Image
            ...
            {/* Center Content */}
            <div className="flex flex-col md:gap-2 max-md:gap-1 max-[340px]:!gap-1 2xl:gap-2  ">
              {/* Title */}
              <div className="flex justify-between items-center ">
                <Link
                  href={`/${data?.slug}`}
                  className=" md:whitespace-nowrap text-xl max-md:text-[16px] flex items-center gap-2 capitalize leading-5 max-md:mt-0.5 max-[320px]:!text-xs font-semibold"
                >
                  {/* <Image
                    src={`${APP_URL}/${data?.logo}`}
                    alt={`${data?.businessName} logo`}
                    width={500}
                    height={500}
                    className="w-4 h-4 object-contain rounded-full border border-gray-200"
                  /> */}
              ...
              {/* Address */}
              <address className="not-italic text-xs truncate max-md:w-52 2xl:text-[12px] text-gray-700 flex items-center gap-1">
                <MapPin
                  size={16}
                ...
                <span
                  ...
                  className=" md:max-w-120 max-[340px]:!text-xs max-[340px]:!w-20 max-md:text-[12px]"
                >
              ...
              <div className="max-md:flex max-md:flex-col md:flex md:gap-3 gap-1 text-[12px] 2xl:text-[13px] font-medium">
                <div className="flex flex-wrap gap-2">
                  {data?.facilities?.slice(0, 4).map((facility, index) => (
                    <div
                      key={index}
                      className={`flex items-center gap-2 px-2 py-1 border border-gray-200 rounded-md text-[11px] md:text-[12px] ${index > 2 ? "hidden md:flex" : ""}`}
                    >
                      {/* ICON */}
                      {facility?.iconSvg && (
                        <span
                      ...
                      <span
                        title={facility?.name}
                        className="truncate max-w-[100px] text-gray-700 text-xs"
                      >
                        {facility?.name}
                      </span>
                    </div>
          ...
          <div className="flex min-[340px]:!justify-between max-w-[98%] gap-1.5 md:mt-2 mt-0.5  items-center md:hidden ">
            <CustomButton
              showToggle={true}
